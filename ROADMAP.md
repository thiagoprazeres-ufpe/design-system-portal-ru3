...
Issues no GitLab: https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues

### Infra (alta prioridade)

| # | Issue | Bloqueia |
|---|---|---|
| [#1](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/1) | Transferir repo para grupo `stilabs` | CI rodar (#2) |
| [#2](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/2) | Cloudflare: criar API token permanente | Deploy via CI |

### Plugin Penpot (média prioridade)

| # | Issue |
|---|---|
| [#3](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/3) | SDK API incorreta no push de tokens (toast vermelho) |
| [#4](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/4) | Pull com MR via GitLab API |
| [#5](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/5) | Validador de marca (contraste, área de proteção, redução) |

### Penpot infra / scripts

| # | Issue |
|---|---|
| [#6](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/6) | `export-snapshot` exige PENPOT_PASSWORD (asset URL não aceita PAT) |
| [#8](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/8) | Penpot self-hosted UFPE (v3.0) |

### Roadmap longo prazo

| # | Issue |
|---|---|
| [#7](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/7) | Cloudflare custom domain `ds.ufpe.br` (purge instantâneo) |
| [#9](https://github.com/thiagoprazeres-ufpe/design-system-portal-ru3/issues/9) | Vetorização real do brasão (paths nomeados) |
